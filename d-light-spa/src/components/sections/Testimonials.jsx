    ...
    <section className="py-12 md:py-20 bg-white">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
          ...
          <p className="text-gray-500 leading-relaxed">Hear what our happy clients have to say about their experience at DLight Spa. Their satisfaction is our greatest achievement.</p>
        </div>
